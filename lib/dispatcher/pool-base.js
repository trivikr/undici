...
class PoolBase extends DispatcherBase {
  ...
  [kDispatch] (opts, handler) {
    if (this[kUrl] && opts.origin != null && util.parseOrigin(opts.origin).origin !== this[kUrl].origin) {
      throw new InvalidArgumentError('Pool cannot dispatch requests to a different origin')
    }
