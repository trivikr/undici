...
class Client extends DispatcherBase {
  ...
  [kDispatch] (opts, handler) {
    if (opts.origin != null && util.parseOrigin(opts.origin).origin !== this[kUrl].origin) {
      throw new InvalidArgumentError('Client cannot dispatch requests to a different origin')
    }
