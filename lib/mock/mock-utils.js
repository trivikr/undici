...
const { serializePathWithQuery, lazyHeaders } = require('../core/util')
...
function mockDispatch (opts, handler) {
  ...
  function handleReply (mockDispatches, _data = data) {
    ...
    handler.onResponseStart?.(controller, statusCode, lazyHeaders(responseHeaders), getStatusText(statusCode))
    handler.onResponseData?.(controller, Buffer.from(responseData))
    handler.onResponseEnd?.(controller, lazyHeaders(responseTrailers))
